...
public final class QRCodeUtil extends LuminanceSource {
    ...
    public static void main(String[] args) {
        ...
        try {
            // 生成二维码图片，并返回图片路径
            String pathName = generateQRCode(text, width, height, format, "D:\\new111.png");
...
//    		File fi2=new File("e:\\lala");
//    		BufferedImage bg= ImageIO.read(fi2);//获取北京图片
//    		Graphics2D g=bg.createGraphics();
//    		int width1=image.getWidth(null) > bg.getWidth() * 5/10? (bg.getWidth() * 5/10) : image.getWidth(null);
//    		int height1=image.getHeight(null) > bg.getHeight() *5 /10? (bg.getHeight() * 5/10) : image.getWidth(null);
//    		g.drawImage(image,(bg.getWidth()- width1)/2,(bg.getHeight()-height1)/2,width1,height1,null);
//    		g.dispose();
//    		bg.flush();
//    		image.flush();
//    		ImageIO.write(bg,"png", fi2);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="grey" id="id-text2">待客之道管理系统</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy;云物益邦</h4>
                    </div>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form class="sign-up-form" id="sign-up-form">
                                        ...
                                        <label class="block clearfix">
                                            ...
                                            <label class="block clearfix">
												<span class="block input-icon input-icon-right">
												<input type="text" class="form-control" id="mobile" name="mobile" placeholder="电话号码(必需)"/>
                                            ...
                                            <label class="block clearfix">
											<span class="block input-icon input-icon-right">
											<input type="text" class="form-control" id="maileCode" name="maileCode" placeholder="验证码(必需)"/>
											<i class="ace-icon fa fa-user"></i>
											</span>
                                            </label>
                                            <label for="maileCode"></label>
                                     ...
                                     <button onclick="getCode()" class="send">获取验证码</button>
                                </div>
...
<script >
	...
	$.ajax({
         url:"http://localhost:8080/ims/checkCode",
         data:{moblie:mobile},
         type:"POST",
         dataType:"json",

                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover user-list">
                                    <thead>
                                    <tr>
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券名字</th> 
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券图片</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券介绍</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>有效期起</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>有效期止</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>适用商户</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>折扣率</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>金额</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>满减</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>是否找零</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>成长度数量</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券进货价</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券销售价</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>买本券所需要金币</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>用户是否重复领取</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券来源</th>
                                    ...
                                    <c:forEach items="${list.list}" var="list">
                                             <tr>
                                            <td style="display:none;" class="cid" >${list.cid}</td>
                                            <td class="ctitle" >${list.ctitle}</td> 
                                            
                                            <%-- <td class="cimg">${list.cimg}</td> --%>
                                           <td class = "cimg">
                                           <img src = "${path }/uploa/image/${list.cimg}">
                                            ...
                                            <td class="cisrepeat">${list.cisrepeat}</td>
                                            <td class="uaid">
                                            <c:if test="${list.uaid==0}"><span
                                                        class="label label-sm label-warning arrowed arrowed-righ">系统</span></c:if>
                                                <c:if test="${list.uaid!=0}"><span
                                                        class="label label-sm label-success arrowed arrowed-righ">${list.adminusers.auname }</span></c:if>
                                            </td>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="text" id="form-add-cid" name="cid" style="display: none"
                                                                   placeholder="商户ID"/>
                                                        </div>
                                                        ...
                                                        <label for="form-add-cimg">优惠券图片<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-cimg"
                                                                   name="cimg" placeholder="优惠券图片"/>
                                                        </div>
                                                        ...
                                                        <label for="form-add-cintegration">成长数量<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-cintegration"
                                                                   name="cintegration" placeholder="成长数量"/>
                                                        </div>
                                                        ...
                                                        <label for="form-add-cisrepeat">是否重复领取<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-cisrepeat"
                                                                   name="cisrepeat" placeholder="是否重复领取"/>
                                                        </div>
                                                        <label for="form-add-uaid">优惠券来源<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-uaid"
                                                                   name="uaid" placeholder="优惠券来源"/>
                                                        </div>
                                                    </div>
                                                </div>

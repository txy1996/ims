                ...
                <div class="page-header">
                    <h1>
                        ...
                        <small>
                            ...
                            共${list.total}个&emsp;
                            <shiro:hasPermission name="couponclass:add">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover user-list">
                                    <thead>
                                    <tr>
                                        <!-- <th><i class="fa  bigger-110 hidden-480"></i>优惠券分类ID</th>  -->
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券分类名</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>优惠券分类简介</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>所属上级分类</th>
                                    ...
                                    <shiro:hasPermission name="couponclass:list">
                                    <c:forEach items="${list.list}" var="list">
                                             <tr>
                                            <td style="display:none;" class="ccid" >${list.ccid}</td>
                                            <td class="ccname" >${list.ccname}</td> 
                                            <td class="ccinfo">${list.ccinfo}</td>
                                            <td class="ccccid">${list.ccccid}</td>

                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <shiro:hasPermission name="couponclass:update">
                                                    ...
                                                    <shiro:hasPermission name="couponclass:delete">
                                                         <c:if test="${list.ccname ne 'admin'}">
                                                    ...
                                                    <shiro:lacksPermission name="couponclass:update">
                                                            <shiro:lacksPermission name="couponclass:delete">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        <customTag:hasAnyPermissions name="couponclass:update,couponclass:delete">
                                    ...
                                    <%--  <shiro:lacksPermission name="couponclass:show">
                                    ...
                                    <ul class="pagination">
                                        <c:choose>
                                            <c:when test="${list.hasPreviousPage}">
                                                <li><a href="${path}/couponclass/list?pageNum=1">首页</a></li>
                                                <li>
                                                    <a href="${path}/couponclass/list?pageNum=${list.pageNum-1}"
                                                       aria-label="Previous">
                                        ...
                                        <c:forEach items="${list.navigatepageNums }" var="page">
                                            <c:if test="${page==list.pageNum}">
                                                <li class="active"><a
                                                        href="${path}/couponclass/list?pageNum=${page}">${page}</a></li>
                                            </c:if>
                                            <c:if test="${page!=list.pageNum}">
                                                <li><a href="${path }/couponclass/list?pageNum=${page}">${page}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <c:choose>
                                            <c:when test="${list.hasNextPage }">
                                                ...
                                                <li><a href="${path }/couponclass/list?pageNum=${list.pages}">末页</a></li>
                                            </c:when>
                                            <c:otherwise>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="form-add-ccid" style="display: none">优惠券分类ID<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-ccid" name="ccid" style="display: none"
                                                                   placeholder="优惠券分类ID"/>
                                                        </div> 
                                                        <label for="form-add-bname">优惠券分类名<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-ccname" name="ccname" 
                                                                   placeholder="优惠券分类名"/>
                                                        </div> 
                                                        <label for="form-add-password">优惠券分类简介<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-ccinfo"
                                                                   name="ccinfo" placeholder="优惠券分类简介"/>
                                                        </div>
                                                    </div>
                                                </div>
...
<!-- 与此页相关的内联脚本 -->
<script src="${path}/assets/custom-js/coupon/couponclass.js"></script>

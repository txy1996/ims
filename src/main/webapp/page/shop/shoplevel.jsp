                                ...
                                <table id="simple-table" class="table  table-bordered table-hover user-list">
                                    ...
                                    <tr>
                                      <!-- <th class="center">
                                        ...
                                        <th><i class="fa  bigger-110 hidden-480"></i>店铺名</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>积分范围</th>
                                        <th><i class="fa  bigger-110 hidden-480"></i>等级说明</th>
                                    ...
                                    <c:forEach items="${list.list}" var="list">
                                            ...
                                            <td style = "display: none" class="slid" >${list.slid}</td> 
                                            <td class="slname">${list.slname}</td>
                                            <td class="slintegration">${list.slintegration}</td>
                                            <td class="slinfo">${list.slinfo}</td>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <shiro:hasPermission name="grade:delete">
                                                         <c:if test="${list.slname ne 'admin'}">
                                                    ...
                                                    <shiro:lacksPermission name="grade:update">
                                                            <shiro:lacksPermission name="grade:delete">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        <customTag:hasAnyPermissions name="grade:update,grade:delete">
                                    ...
                                    <%-- <shiro:lacksPermission name="grade:show">
                                    ...
                                    <ul class="pagination">
                                        <c:choose>
                                            <c:when test="${list.hasPreviousPage}">
                                                <li><a href="${path}/grade/list?pageNum=1">首页</a></li>
                                                <li>
                                                    <a href="${path}/grade/list?pageNum=${list.pageNum-1}"
                                                       aria-label="Previous">
                                        ...
                                        <c:forEach items="${list.navigatepageNums }" var="page">
                                            <c:if test="${page==list.pageNum}">
                                                <li class="active"><a
                                                        href="${path}/grade/list?pageNum=${page}">${page}</a></li>
                                            </c:if>
                                            <c:if test="${page!=list.pageNum}">
                                                <li><a href="${path }/grade/list?pageNum=${page}">${page}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <c:choose>
                                            <c:when test="${list.hasNextPage }">
                                                ...
                                                <li><a href="${path }/grade/list?pageNum=${list.pages}">末页</a></li>
                                            </c:when>
                                            <c:otherwise>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="form-group">
                                                       <label for="form-add-slid" style="display: none">平台店铺的等级名称ID<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-slid" name="slid" style="display: none"
                                                                   placeholder="平台店铺的等级名称ID"/>
                                                        </div>  
                                                        <label for="form-add-slname">平台店铺的等级名<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-slname" name="slname" 
                                                                   placeholder="平台店铺的等级名"/>
                                                        </div>
                                                        <label for="form-add-slintegration">该等级的积分范围<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-slintegration"
                                                                   name="slintegration" placeholder="该等级的积分范围"/>
                                                        </div>
                                                        <label for="form-add-slinfo">等级的说明<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="form-add-slinfo" name="slinfo"
                                                                   placeholder="等级的说明"/>
                                                        </div>
...
<!-- 与此页相关的内联脚本 -->
<script src="${path}/assets/custom-js/shoplevel.js"></script>

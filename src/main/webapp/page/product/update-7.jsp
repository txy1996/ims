									...
									<form class="product-update-from" enctype="multipart/form-data">
										...
										<div class="form-group">
											<div class=" input-group input-group-sm col-xs-4"
												...
												<span class="input-group-addon label-success"
													id="basic-addon1">商品名称</span> <input type="text"
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													id="basic-addon3">商品图片</span> <input type="text"
											...
											<div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													id="basic-addon4">商品状态</span> <select id="state"
										...
										<div class="form-group ">
											...
											<div class=" input-group input-group-sm col-xs-4 "
												...
												style="float: left; margin: 25px 180px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon4">推荐广告词</span> <input type="text"
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4"
												style="float: left; margin: 25px 150px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon1">商品原价</span> <input type="text"
...
<!-- 	<script type="text/javascript" charset="utf-8"
 ...
 -->
	...
	<!-- 与此页相关的内联脚本 -->
	<script src="${path}/assets/custom-js/product/update-7.js"></script>
	<script type="text/javascript">

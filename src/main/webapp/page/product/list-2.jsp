									...
									<form class="product-add-from" name="product-add-from" enctype="multipart/form-data">
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													...
													placeholder="请选择预览图片..." aria-describedby="basic-addon1"
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4"
												style="float: left; margin: 25px 150px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon1">价格预算区间</span> <input style="width:100px;" type="text" name="price" placeholder="价格，如150" aria-describedby="basic-addon1"> 至 <input style="width:150px;" type="text" name="yprice" placeholder="请输入价格..." aria-describedby="basic-addon1">
											</div>
											<!-- <div class=" input-group input-group-sm col-xs-4 "
												style="float: left; margin: 25px 180px 0 0;">
												<span class="input-group-addon label-success"

...
<body class="no-skin" onload="load(${pcid})">
										...
										<div class="form-group">
											<div class=" input-group input-group-sm col-xs-4"
												...
												<span class="input-group-addon label-success"
													...
													placeholder="请输入姓名..." aria-describedby="basic-addon1">
											</div>
											<!-- <div class=" input-group input-group-sm col-xs-4"
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4"
												...
												<span class="input-group-addon label-success"
													...
													placeholder="请输入每小时的价格..." aria-describedby="basic-addon1">
											</div>
											...
											<div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													...
													placeholder="请输入擅长领域..." aria-describedby="basic-addon1">
	...
	<script type="text/javascript">
		...
		function addProduct() {
			console.log(new FormData($('.product-add-from')[0]))
			$.ajax({

									...
									<form class="product-update-from" enctype="multipart/form-data">
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													id="basic-addon3">预览图片</span> <input type="text"
										...
										<div class="form-group ">
											...
											<%-- <div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													...
													value="${response.spunum}" aria-describedby="basic-addon1">
										...
										<div class="form-group ">
											 <div class=" input-group input-group-sm col-xs-4"
												style="float: left; margin: 25px 150px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon1">价格预算区间</span> <input type="text" style="width:100px;" name="price" value="${response.price}" placeholder="价格，如100" aria-describedby="basic-addon1"> 至 <input type="text" style="width:100px;" name="yprice"
													value="${response.yprice}" placeholder="请输入价格..."
											...
											<%-- <div class=" input-group input-group-sm col-xs-4 "
												style="float: left; margin: 25px 180px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon4">商品优惠价</span> <input type="text"
...
<!-- 	<script type="text/javascript" charset="utf-8"
 ...
 -->
	...
	<!-- 与此页相关的内联脚本 -->
	<script src="${path}/assets/custom-js/product/update-2.js"></script>
	<script type="text/javascript">

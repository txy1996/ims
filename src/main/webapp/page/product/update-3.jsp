									...
									<form class="product-update-from" enctype="multipart/form-data">
										...
										<div class="form-group">
											<div class=" input-group input-group-sm col-xs-4"
												...
												<span class="input-group-addon label-success"
													id="basic-addon1">姓名</span> <input type="text"
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4 "
												...
												<span class="input-group-addon label-success"
													id="basic-addon3">形象图片</span> <input type="text"
										...
										<div class="form-group ">
											<div class=" input-group input-group-sm col-xs-4"
												style="float: left; margin: 25px 150px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon1">价格/小时</span> <input type="text"
													class="form-control inputcommodity" name="price"
													value="${response.price}" placeholder="请输入每小时的价格..."
											...
											<div class=" input-group input-group-sm col-xs-4 "
												style="float: left; margin: 25px 180px 0 0;">
												<span class="input-group-addon label-success"
													id="basic-addon4">擅长领域</span> <input type="text"
													class="form-control inputcommodity" name="ptitle"
													value="${response.ptitle}" placeholder="输入擅长领域..."
													aria-describedby="basic-addon1">
...
<!-- 	<script type="text/javascript" charset="utf-8"
 ...
 -->
	...
	<!-- 与此页相关的内联脚本 -->
	<script src="${path}/assets/custom-js/product/update-3.js"></script>
	<script type="text/javascript">

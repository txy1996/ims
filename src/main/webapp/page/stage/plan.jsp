                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover perm-list">
                                    <thead>
                                    <tr>
                                        <!-- <th><i class="fa fa-id-card bigger-110 hidden-480"></i>阶段ID</th> -->
                                        ...
                                        <th><i class="fa fa-key bigger-110 hidden-480"></i>查看详情</th>
                                    ...
                                    <c:forEach items="${stage.list}" var="stage">
                                        <tr>
                                            ...
                                            <td class="sid">${stage.scheme.sname}</td>
                                            <td class="ssname">${stage.ssname}</td>
                                            <td class="ssinfo">${stage.ssinfo}</td>
                                            <td><a href="getplan?id=${stage.ssid}">点击查看详情</a></td>
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <shiro:lacksPermission name="plan:update">
                                                        <shiro:lacksPermission name="plan:delete">
                                    ...
                                    <%-- <shiro:lacksPermission name="plan:list">
                                    ...
                                    <ul class="pagination">
                                        <c:choose>
                                            <c:when test="${stage.hasPreviousPage}">
                                                <li><a href="${path}/plan/list?pageNum=1">首页</a></li>
                                                <li>
                                                    <a href="${path}/plan/list?pageNum=${stage.pageNum-1}"
                                                       aria-label="Previous">
                                        ...
                                        <c:forEach items="${stage.navigatepageNums }" var="page">
                                            <c:if test="${page==stage.pageNum}">
                                                <li class="active"><a
                                                        href="${path}/plan/list?pageNum=${page}">${page}</a></li>
                                            </c:if>
                                            <c:if test="${page!=stage.pageNum}">
                                                <li><a href="${path }/plan/list?pageNum=${page}">${page}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <c:choose>
                                            <c:when test="${stage.hasNextPage }">
                                                ...
                                                <li><a href="${path }/plan/list?pageNum=${stage.pages}">末页</a></li>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <input type="hidden" name="ssid" class="form-control" id="idInput">
                                                    <div class="form-group">
                                                        <label for="nameInput">所属方案<span style="color:#F00">*</span></label>
                                                        <div>
                                                        ...
                                                        <label for="urlInput">阶段名称<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
                                                            <input type="text" id="ssname" name="ssname"
                                                                   placeholder=""/>
                                                        </div>
                                                        <label for="codeInput">阶段介绍<span
                                                                style="color:#F00">*</span></label>
                                                        <div>
...
<!-- 与此页相关的内联脚本 -->
<script src="${path}/assets/custom-js/stage/stage.js"></script>

                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover perm-list">
                                    <thead>
                                    <tr>
                                        <th><i class="fa fa-id-card bigger-110 hidden-480"></i>1</th>
                                        <th><i class="fa fa-envira bigger-110 hidden-480"></i>2</th>
                                        <th><i class="fa fa-edge bigger-110 hidden-480"></i>3</th>
                                        <th><i class="fa fa-key bigger-110 hidden-480"></i>4</th>
                                        <th><i class="fa fa-key bigger-110 hidden-480"></i>5</th>
                                    ...
                                    <c:forEach items="${plan.list}" var="plan">
                                        <tr>
                                            <td class="ssid">${plan.sid}</td>
                                            <td class="sid">${plan.scid}</td>
                                            <td class="ssname">${plan.sname}</td>
                                            <td class="ssinfo">${plan.sinfo}</td>
                                            <td class="ssinfo">${plan.scheme_stage.ssname}</td>
                                            <td>
